...
Enables client-side support for [Mermaid diagrams](https://mermaid.js.org/) in Markdown/MDX content in a Starlight site. 'Client-side' means the Mermaid diagrams are rendered to SVGs on the user browser, as opposed to generating them on the server.
